...
\title{\textbf{The Fundamental Theorem of Arithmetic}}
\author{0xHaru}
\date{\today}
...
If a prime $p$ divides the product $a \cdot b$ of two integers $a$ and $b$, then $p$
...
\begin{enumerate}
  ...
  \item \emph{Otherwise,} there are integers $a$ and $b$ where $m = a \cdot b$
        ...
        $a = p_1 \cdot p_2 \cdot \ldots \cdot p_j$ and $b = q_1 \cdot q_2 \cdot \ldots \cdot q_k$
        are products of primes. But then
        \[
            m \;=\; a \cdot b
              \;=\; p_1 \cdot p_2 \cdot \ldots \cdot p_j \cdot q_1 \cdot q_2 \cdot \ldots \cdot q_k
        \]
...
\medskip
We see that $p_1$ divides $q_1 \cdot q_2 \cdot \ldots \cdot q_k$, so $p_1$ divides some
...
conclude that
\[
    p_2 \cdot \ldots \cdot p_j \;=\; q_2 \cdot \ldots \cdot q_k.
\]
