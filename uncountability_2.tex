...
\[
    ...
    \end{cases}
\]
Since every digit $c_i$ belongs to $\{2,3\}$, the constructed number lies in $(0,1)$.
...
This section presents the diagonalisation of Step~2 in simpler terms.
...
\medskip
\noindent\textbf{The conclusion.}\quad Since this construction applies to any
...
Georg Cantor (1845--1918), who published it in 1891.
